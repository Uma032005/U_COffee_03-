          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  Coffee energizes the mind with its rich aroma and bold flavor, perfect for a quick boost.
Tea soothes the soul with its gentle taste and calming warmth, ideal for relaxation.
                </p>
